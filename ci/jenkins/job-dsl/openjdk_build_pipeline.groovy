...
pipelineJob(jobName) {
    ...
    properties {
        ...
        // agent{} block inside a running build) as a concurrent build of the
        // same job, blocking the task as a Queue$BlockedItem forever.
        // See: https://issues.jenkins.io/browse/JENKINS-44654
